  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'focus-visible:border-primary-600 aria-invalid:border-error-500 border border-neutral-500 disabled:pointer-events-none disabled:cursor-not-allowed',
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="pointer-events-none size-4 shrink-0 text-neutral-700" />
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'relative z-50 max-h-(--radix-select-content-available-height) min-w-(--radix-select-trigger-width) origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border border-neutral-500 bg-neutral-50 p-1 text-neutral-900 shadow-md',
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn('px-2 py-1.5 text-sm text-neutral-700', className)}
      {...props}
    />
  );
}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        'pointer-events-none -mx-1 my-1 h-px bg-neutral-500',
        className
      )}
      {...props}
    />
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        'z-10 flex cursor-default items-center justify-center py-1 text-neutral-700',
        className
      )}
      {...props}
    >
